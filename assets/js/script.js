...
function testLocalStorage () {
    tempValue = []
    searchedCitiesNull = (localStorage.getItem("searchedCities"));
    if (searchedCitiesNull == null) {
        localStorage.setItem("searchedCities", JSON.stringify(tempValue));
    }
    console.log(searchedCitiesNull)
}
testLocalStorage ()
